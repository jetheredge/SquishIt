...
namespace SquishIt.Framework.Resolvers
{
    public class HttpResolver: IResolver
    {
        ...
        public IEnumerable<string> TryResolveFolder(string path, bool recursive, IEnumerable<string> allowedExtensions, IEnumerable<string> disallowedFileExtensions) 
        {
