...
namespace SquishIt.Tests
{
    ...
    {
        private readonly string _unmimifiedJavaScript1 = TestUtilities.NormalizeLineEndings(@"
        ...
        private const string ExpectedMinifiedJavaScript1 =
            "function product(n,t){return n*t}function sum(n,t){return n+t}";


        private readonly string _javaScript2 = TestUtilities.NormalizeLineEndings(@"function sum(a, b){
																						return a + b;
																			 }");

        private JavaScriptBundle _javaScriptBundle;
        private JavaScriptBundle _javaScriptBundle2;
        private JavaScriptBundle _debugJavaScriptBundle;
        private JavaScriptBundle _debugJavaScriptBundle2;
        private StubFileWriterFactory _fileWriterFactory;
        private StubFileReaderFactory _fileReaderFactory;
        private StubCurrentDirectoryWrapper _currentDirectoryWrapper;
        private IHasher _hasher;
        private StubBundleCache _stubBundleCache;
        ...
        public void Setup()
        {
            ...
            _fileWriterFactory = new StubFileWriterFactory();
            _fileReaderFactory = new StubFileReaderFactory();
            _currentDirectoryWrapper = new StubCurrentDirectoryWrapper();
            _stubBundleCache = new StubBundleCache();

            var retryableFileOpener = new RetryableFileOpener();
            _hasher = new Hasher(retryableFileOpener);

            _fileReaderFactory.SetContents(_unmimifiedJavaScript1);

            _javaScriptBundle = new JavaScriptBundle(nonDebugStatusReader,
                                                        _fileWriterFactory,
                                                        _fileReaderFactory,
                                                        _currentDirectoryWrapper,
                                                        _hasher,
                                                        _stubBundleCache);

            _javaScriptBundle2 = new JavaScriptBundle(nonDebugStatusReader,
                                                        _fileWriterFactory,
                                                        _fileReaderFactory,
                                                        _currentDirectoryWrapper,
                                                        _hasher,
            ...
            _debugJavaScriptBundle = new JavaScriptBundle(debugStatusReader,
                                                        _fileWriterFactory,
                                                        _fileReaderFactory,
                                                        _currentDirectoryWrapper,
                                                        _hasher,
            ...
            _debugJavaScriptBundle2 = new JavaScriptBundle(debugStatusReader,
                                                        _fileWriterFactory,
                                                        _fileReaderFactory,
                                                        _currentDirectoryWrapper,
                                                        _hasher,
        ...
        public void CanBundleJavaScript()
        {
            ...
            Assert.AreEqual(ExpectedMinifiedJavaScript1, _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_1.js")]);
        }
        ...
        public void CanBundleJsVaryingOutputBaseHrefRendersIndependantUrl() 
        {
            ...
            string tagNoBaseHref = _javaScriptBundle2
                            .Add("/js/first.js")
                            .Add("/js/second.js")
                            .Render("/js/output.js");
        ...
        public void CanCreateNamedBundle()
        {
            ...
            var tag = _javaScriptBundle.RenderNamed("TestNamed");

            Assert.AreEqual("<script type=\"text/javascript\" src=\"js/output_namedbundle.js?r=36286D0CEA57C5ED24B868EB0D2898E9\"></script>", tag);
            Assert.AreEqual(ExpectedMinifiedJavaScript1, _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_namedbundle.js")]);
        }
        ...
        public void CanBundleJavaScriptWithRemote()
        {
            ...
            Assert.AreEqual(ExpectedMinifiedJavaScript1, _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_1_2.js")]);
        }
        ...
        public void CanCreateNamedBundleWithRemote()
        {
            ...
            var tag = _javaScriptBundle.RenderNamed("TestCdn");
            ...
            Assert.AreEqual(ExpectedMinifiedJavaScript1, _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_3_2.js")]);
        }
        ...
        public void CanBundleJavaScriptWithEmbeddedResource()
        {
            ...
            Assert.AreEqual(ExpectedMinifiedJavaScript1, _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_Embedded.js")]);
        }

        [Test]
        public void CanDebugBundleJavaScriptWithEmbeddedResource()
        {
            var tag = _debugJavaScriptBundle
                    .AddEmbeddedResource("~/js/test.js", "SquishIt.Tests://EmbeddedResource.Embedded.js")
                    .Render("~/js/output_Embedded.js");
        ...
        {
            _debugJavaScriptBundle
                    .Add("~/js/test1.js")
                    .Add("~/js/test2.js")
                    .AsNamed("TestWithDebug", "~/js/output_3.js");

            var tag = _debugJavaScriptBundle.RenderNamed("TestWithDebug");
        ...
        public void CanRenderDebugTagsTwice()
        {
            ...
            _debugJavaScriptBundle2
                    .Add("~/js/test1.js")
                    .Add("~/js/test2.js")
                    .AsNamed("TestWithDebug", "~/js/output_4.js");

            var tag1 = _debugJavaScriptBundle.RenderNamed("TestWithDebug");
            var tag2 = _debugJavaScriptBundle2.RenderNamed("TestWithDebug");
        ...
        public void CanCreateNamedBundleWithDebug()
        {
            ...
            var tag = _debugJavaScriptBundle.RenderNamed("NamedWithDebug");
        ...
        public void CanCreateBundleWithNullMinifer()
        {
            ...
            Assert.AreEqual(_unmimifiedJavaScript1 + "\n", _fileWriterFactory.Files[TestUtilities.PreparePath(Environment.CurrentDirectory + @"\js\output_6.js")]);
        }
        ...
        public void CanCreateBundleWithJsMinMinifer()
        {
            ...
            Assert.AreEqual ("\nfunction product(a,b)\n{return a*b;}\nfunction sum(a,b){return a+b;}", _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_7.js")]);
        }
        ...
        public void CanCreateBundleWithJsMinMiniferByPassingInstance()
        {
            ...
            Assert.AreEqual ("\nfunction product(a,b)\n{return a*b;}\nfunction sum(a,b){return a+b;}", _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_jsmininstance.js")]);
        }
        ...
        public void CanCreateEmbeddedBundleWithJsMinMinifer()
        {
            ...
            Assert.AreEqual ("\nfunction product(a,b)\n{return a*b;}\nfunction sum(a,b){return a+b;}", _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_embedded7.js")]);
        }
        ...
        {
            _fileReaderFactory.SetFileExists(false);
            ...
            Assert.AreEqual(ExpectedMinifiedJavaScript1, _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_9.js")]);

            _fileReaderFactory.SetContents(_javaScript2);
            _fileReaderFactory.SetFileExists(true);
            _javaScriptBundle.ClearCache();
        ...
        public void CanRerenderFiles()
        {
            ...
            Assert.AreEqual(ExpectedMinifiedJavaScript1, _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_10.js")]);

            _fileReaderFactory.SetContents(_javaScript2);
            _fileReaderFactory.SetFileExists(true);
            _fileWriterFactory.Files.Clear();
            _javaScriptBundle.ClearCache();
            ...
            Assert.AreEqual ("function sum(n,t){return n+t}", _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_10.js")]);
        }
        ...
        public void CanBundleJavaScriptWithHashInFilename()
        {
            ...
            Assert.AreEqual(ExpectedMinifiedJavaScript1, _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_36286D0CEA57C5ED24B868EB0D2898E9.js")]);
        }
        ...
        public void CanBundleJavaScriptWithUnderscoresInName()
        {
            ...
            Assert.AreEqual(ExpectedMinifiedJavaScript1, _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\outputunder_36286D0CEA57C5ED24B868EB0D2898E9.js")]);
        }
        ...
        public void CanCreateNamedBundleWithForcedRelease()
        {
            ...
            var tag = _javaScriptBundle.RenderNamed("ForceRelease");

            Assert.AreEqual("<script type=\"text/javascript\" src=\"js/output_forcerelease.js?r=36286D0CEA57C5ED24B868EB0D2898E9\"></script>", tag);
            Assert.AreEqual(ExpectedMinifiedJavaScript1, _fileWriterFactory.Files[TestUtilities.PrepareRelativePath(@"js\output_forcerelease.js")]);
        }
        ...
        {
            string tag = _debugJavaScriptBundle
                    .Add("~/js/test1.js")
                    .Add("~/js/test2.js")
                    .WithAttribute("charset", "utf-8")
        ...
        public void CanCreateCachedBundleAssetTag()
        {
            ...
            var content = _javaScriptBundle.RenderCached("Test");
            _javaScriptBundle.ClearCache();
            var tag = _javaScriptBundle.RenderCachedAssetTag("Test");
        ...
        {
            var tag1 = _debugJavaScriptBundle
                    .Add("~/js/test.js")
                    .ForceRelease()
                    .AsCached("Test", "~/assets/js/main");

            var content = _debugJavaScriptBundle.RenderCached("Test");
            _javaScriptBundle.ClearCache();
            var tag2 = _debugJavaScriptBundle.RenderCachedAssetTag("Test");
        ...
        public void CanBundleDirectoryContentsInDebug()
        {
            ...
            using (new ResolverFactoryScope(typeof(Framework.Resolvers.FileSystemResolver).FullName, StubResolver.ForDirectory(new[] { file1, file2 })))
            {
                var frf = new StubFileReaderFactory();
                frf.SetContentsForFile(file1, _javaScript2.Replace("sum", "replace"));
                frf.SetContentsForFile(file2, _unmimifiedJavaScript1);
        ...
        [Test]
        public void CanBundleDirectoryContentsInDebugIgnoresDuplicates() {
            var path = Guid.NewGuid().ToString();
            var file1 = TestUtilities.PreparePath(Environment.CurrentDirectory + "\\" + path + "\\file1.js");
            var file2 = TestUtilities.PreparePath(Environment.CurrentDirectory + "\\" + path + "\\file2.js");
        ...
        [Test]
        public void CanBundleDirectoryContentsInReleaseIgnoresDuplicates() {
            var path = Guid.NewGuid().ToString();
            var file1 = TestUtilities.PrepareRelativePath(path + "\\file1.js");
            var file2 = TestUtilities.PrepareRelativePath(path + "\\file2.js");
